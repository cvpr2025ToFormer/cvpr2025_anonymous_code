...
def resnet18_cbam(pretrained=False, **kwargs):
    """Constructs a ResNet-18 model_old.

    Args:
        pretrained (bool): If True, returns a model_old pre-trained on ImageNet
    """
...
def resnet34_cbam(pretrained=False, **kwargs):
    """Constructs a ResNet-34 model_old.
...
def resnet50_cbam(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model_old.
...
def resnet101_cbam(pretrained=False, **kwargs):
    """Constructs a ResNet-101 model_old.
...
def resnet152_cbam(pretrained=False, **kwargs):
    """Constructs a ResNet-152 model_old.
